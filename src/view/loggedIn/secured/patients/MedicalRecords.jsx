                  ...
                  <div className="lg:col-span-1  flex flex-col items-center">
                    <div className="bg-white w-full max-w-sm rounded-lg shadow-md flex flex-col items-center p-3 mx-auto mb-4 h-full">
                      ...
                      <p className="text-gray-600">
                        Age:{" "}
                        {differenceInYears(new Date(), userData?.data?.dob)}
                      </p>
                      <p className="text-gray-600">
                        EHR: {userData?.data?.ehr}
                      </p>
                      <Link to={"/settings"}>
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white w-full rounded-lg shadow-md p-6 mx-auto">
                      <ul className="text-gray-700 grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 mt-4 p-6">
                        <li>
                          <strong>EHR:</strong> {userData?.data?.ehr}
                        </li>
                        ...
                        <li className="capitalize">
                          ...
                          {userData?.data?.blood_type} (Positive)
                        </li>
                        <li className="capitalize">
                          <strong>Allergies:</strong>{" "}
                          {userData?.data?.allergies}
                        </li>
                        <li className="capitalize">
                          <strong>Current Medication:</strong>{" "}
                          <span className="capitalize">
                            {userData?.data?.current_medication}
                          </span>
                        </li>
                        <li>
                          <strong>Height:</strong> {userData?.data?.height} ft
                        </li>
                        <li>
                          <strong>Weight:</strong> {userData?.data?.weight} kg
                        </li>
                        <li>

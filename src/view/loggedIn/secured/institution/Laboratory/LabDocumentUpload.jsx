    ...
    <div className="bg-white max-w-3xl w-full p-6 rounded-md shadow-md overflow-y-auto max-h-[90vh]">
      ...
      <div className="space-y-4 text-sm text-gray-800">
        ...
        <p>
          ...
          laboratory scientist on BADANIX. To ensure high standards in medical
          laboratory practice, all applicants must upload the following
          documents for verification.
        </p>

        <p>
          To practice as a Medical Laboratory Scientist with BADANIX, you must
          be registered with the Medical Laboratory Science Council or the
          equivalent regulatory body in your country. You may also need to
          register your laboratory facility with the appropriate business
          registration agency in your country, such as:
        </p>
        ...
        <div>
          ...
          <p>
            Ensure you register your laboratory business with the appropriate
        ...
        <div>
          ...
          <ul className="list-decimal pl-6 space-y-1">
            <li>
              <strong>Bachelor’s Degree in Medical Laboratory Science (MLS):</strong> Certified copy from an accredited institution.
            </li>
            <li>
              <strong>Practice License:</strong> Valid license issued by your country’s Medical Laboratory Science Council or equivalent.
            </li>
            <li>
              <strong>Certification (Optional):</strong> Specialist certifications like ASCP (USA), HCPC (UK), or equivalent.
            </li>
            <li>
              <strong>Medical Fitness Report:</strong> Issued within the last two months.
            </li>
            <li>
            ...
            <li>
              <strong>Full-Size Picture of Yourself:</strong> Recent photo in professional attire.
            </li>
            <li>
              <strong>Passport Photograph:</strong> No cap, scarf, or glasses; both ears visible.
            </li>
            <li>
              <strong>Picture of the Principal Owner:</strong> Clear image of the company’s principal owner.
            </li>
            <li>
              <strong>Front Pictures of the Company:</strong> Showing signage with registered name.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            submission. Ensure all documents uploaded are clear, legible, and
            certified to avoid delays.
          </p>
        </div>

        <p>
          You will receive an email notification once your documents have been
        ...
        <p>We look forward to welcoming you as a BADANIX online medical laboratory scientist!</p>
        <p>
          Best Regards,<br />BADANIX Registration Team
        </p>
      </div>

        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white max-w-3xl w-full p-6 rounded-md shadow-md overflow-y-auto max-h-[90vh]">
            ...
            <div className="space-y-4 text-sm text-gray-800">
              <p>Dear Pharmacist,</p>
              <p>
                Thank you for your interest in registering as an online pharmacy
                practitioner on BADANIX. To maintain high standards of
                pharmaceutical practice, all applicants must upload the
              ...
              <div>
                ...
                <p>
                  The BADANIX verification process takes 15 days from
                  submission. Ensure all documents are clear and certified to
                  avoid delays.
                </p>
              </div>
              ...
              <p>
                We look forward to welcoming you as a BADANIX online pharmacy
                practitioner!
              </p>
              <p>
                Best Regards,

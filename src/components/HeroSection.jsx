...
const HeroSection = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: desktopScreen ? `url(${yourBgImageUrl})` : "none",
      }}
    >
      <NavBar />
      ...
      <div className="pt-24 p-8 md:grid md:grid-cols-2 md:gap-8 items-center relative tablet:-mt-[50px]">
        ...
        <div className="text-white flex flex-col gap-y-[34px] order-2 md:order-1 md:-mt-[75px] md-ml-7 lg:-mt-[250px]  lg:leading-loose">
          <div className="lg:w-[800px] tablet:w-[500px] space-x-7 mt-8 md:mt-[100px]">
            <p className="uppercase  mx-[50px] text-xl text-secondary text-center">
              Enhancing patient care through digital health care
            </p>
          ...
          <div className="lg:w-[700px]">
            <p className="lg:text-xl text-md text-center  custom-xs:-mt-3 lg:ml-[60px] tablet:ml-[60px] ">
              Leveraging technology to augment the reach of doctors and provide
              on-demand access, we are making quality healthcare more accessible
              than ever.
            </p>
          </div>
            ...
            <div className="flex ">
              {desktopScreen ? (
                ...
                <div className="flex -mt-3 -mx-3 space-x-8">
                  <Link
                    to="/register"
                    className="bg-white text-primary px-8 py-2 rounded-lg flex items-center shadow-lg custom-xs:mx-[10px] custom-sm:mx-[5px] custom-14:mx-[7px] custom-pixel:mx-[30px]"
                  >
                    <span>Sign Up</span>
                  </Link>
                  <Link
                    to="/auth-login"
                    className="bg-white text-primary px-8 py-2 rounded-lg flex items-center shadow-lg"
                  >
                    <span>Login</span>
                    <MdLogin className="w-6 h-6 text-primary ml-2" />
                  </Link>
                </div>
              )}
            </div>
